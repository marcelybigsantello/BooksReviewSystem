...
public class ControllerExceptionHandler {
	...
	@ExceptionHandler({NoSuchElementException.class, ObjectNotFoundException.class})
	public static ResponseEntity<StandardError> getObjectNotFound(RuntimeException e, HttpServletRequest request) {
